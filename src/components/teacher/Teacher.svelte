...
<div class="row">
    <div class="col-md-4">   
        <img src="{teacher.profileImage || '/assets/user-profile-icon.jpg'}" class="img-fluid mb-3" alt="Teacher profile">
                ...
                <ul class="list-group w-50">
                    {#each teacher.engagements as engagement}
                        <HoverableInteraction>
                            ...
                            >
                                <li class="list-group-item">{engagement.course.name} - {engagement.engagementType}</li>
                            </Link>
                        </HoverableInteraction>
                    {/each}
                </ul>
